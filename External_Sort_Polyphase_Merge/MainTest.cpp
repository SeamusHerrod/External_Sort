...
int main(int argc, char* argv[]) {
  ...
  IsSorted(argv[3], true);

  // You should read the input from argv[1] line by line, each line is one integer to sort.
  // You shoud store sorted array in the same format.
